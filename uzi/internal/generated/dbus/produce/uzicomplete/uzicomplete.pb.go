...
const file_proto_dbus_produce_uzicomplete_proto_rawDesc = "" +
	"\n" +
	"$proto/dbus/produce/uzicomplete.proto\"$\n" +
	"\vUziComplete\x12\x15\n" +
	"\x06uzi_id\x18d \x01(\tR\x05uziIdB-Z+internal/generated/dbus/produce/uzicompleteb\x06proto3"
