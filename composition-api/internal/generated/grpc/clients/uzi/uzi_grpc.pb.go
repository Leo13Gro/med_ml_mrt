...
type UziSrvClient interface {
	...
	DeleteUzi(ctx context.Context, in *DeleteUziIn, opts ...grpc.CallOption) (*empty.Empty, error)
	// IMAGE
...
func (c *uziSrvClient) DeleteUzi(ctx context.Context, in *DeleteUziIn, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type UziSrvServer interface {
	...
	DeleteUzi(context.Context, *DeleteUziIn) (*empty.Empty, error)
	// IMAGE
...
func (UnimplementedUziSrvServer) DeleteUzi(context.Context, *DeleteUziIn) (*empty.Empty, error) {
