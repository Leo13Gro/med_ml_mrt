...
type MedSrvClient interface {
	...
	CreatePatient(ctx context.Context, in *CreatePatientIn, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *medSrvClient) CreatePatient(ctx context.Context, in *CreatePatientIn, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type MedSrvServer interface {
	...
	CreatePatient(context.Context, *CreatePatientIn) (*empty.Empty, error)
...
func (UnimplementedMedSrvServer) CreatePatient(context.Context, *CreatePatientIn) (*empty.Empty, error) {
