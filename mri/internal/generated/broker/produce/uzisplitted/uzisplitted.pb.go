...
var file_uzisplitted_proto_rawDesc = string([]byte{
	0x0a, 0x11, 0x75, 0x7a, 0x69, 0x73, 0x70, 0x6c, 0x69, 0x74, 0x74, 0x65, 0x64, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x22, 0x40, 0x0a, 0x0b, 0x4d, 0x72, 0x69, 0x53, 0x70, 0x6c, 0x69, 0x74, 0x74,
	0x65, 0x64, 0x12, 0x15, 0x0a, 0x06, 0x6d, 0x72, 0x69, 0x5f, 0x69, 0x64, 0x18, 0x64, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x6d, 0x72, 0x69, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x61, 0x67,
...
var (
	...
	file_uzisplitted_proto_rawDescData []byte
)

func file_uzisplitted_proto_rawDescGZIP() []byte {
	file_uzisplitted_proto_rawDescOnce.Do(func() {
		file_uzisplitted_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_uzisplitted_proto_rawDesc), len(file_uzisplitted_proto_rawDesc)))
	})
...
func file_uzisplitted_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_uzisplitted_proto_rawDesc), len(file_uzisplitted_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
